<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        ...
        <head>
            ...
            <title>Register — MovieTix Gold</title>
            ...
            <div class="flex-grow flex items-center justify-center px-6 py-12 relative">
                ...
                <div
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-xs text-neutral-400 mt-2 font-light">Join the luxury MovieTix cinematic club</p>
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/register" method="post" id="registerForm"
                        class="space-y-4" onsubmit="return validatePasswords()">
                        <div>
                            <label class="block text-[10px] font-bold uppercase tracking-widest text-neutral-400 mb-1.5"
                            ...
                            <div class="relative group">
                                ...
                                <input
                                    class="w-full bg-[#0a0a14]/80 border border-white/10 rounded-xl py-2.5 pl-11 pr-4 text-sm text-gray-200 placeholder-neutral-600 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 transition-all font-light"
                                    type="text" id="name" name="name" placeholder="John Doe" required minlength="2"
                                    autocomplete="name">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input
                                    class="w-full bg-[#0a0a14]/80 border border-white/10 rounded-xl py-2.5 pl-11 pr-4 text-sm text-gray-200 placeholder-neutral-600 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 transition-all font-light"
                                    type="password" id="password" name="password" placeholder="Min. 6 characters"
                        ...
                        <button
                            class="w-full py-3.5 px-4 text-sm font-extrabold text-black bg-yellow-500 hover:bg-yellow-400 rounded-xl transition-all shadow-xl shadow-yellow-500/25 active:scale-[0.98] btn-gold-glow flex items-center justify-center gap-2 mt-6"
                            type="submit">
                            Register Club Account <i class="fa-solid fa-arrow-right text-xs"></i>
                        </button>
                    </form>

                    <div class="mt-6 text-center text-xs text-neutral-400 font-light">
                        Already have a membership? <a href="${pageContext.request.contextPath}/login"
                            class="text-yellow-500 font-bold hover:underline">Sign In</a>
                    </div>
                </div>
            </div>
